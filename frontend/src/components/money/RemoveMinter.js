...
class RemoveMinterClass extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      address: '',
  ...
  async handleSubmit(event) {
    ...
    await MoneyContract.removeMinter(this.state.address)
...
export default function RemoveMinter(props) {
  return <RemoveMinterClass {...props}/>;
};
