...
class ChangePresidentClass extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      address: '',
  ...
  async handleSubmit(event) {
    ...
    await CitizenshipContract.changePresident(this.state.address)
...
export default function ChangePresident(props) {
  return <ChangePresidentClass {...props}/>;
};
